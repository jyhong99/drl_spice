...
from .patterns import SPARAM_KEY, NOISE_KEY, LINEARITY_KEY
from .types import KnobValue, SimResult, SimStatus, PathLike
    ...
    def simulate(
        ...
        *,
        ...
        try:
            ...
            return SimResult(performances, aux, SimStatus.OK, "ok", str(run_dir))

        except RuntimeError as e:
            msg = str(e)
            if "timed out" in msg.lower():
                return SimResult(None, {}, SimStatus.TIMEOUT, msg, str(run_dir))
            return SimResult(None, {}, SimStatus.NGSPICE_FAIL, msg, str(run_dir))

        except FileNotFoundError as e:
            return SimResult(None, {}, SimStatus.NO_OUTPUT, f"{type(e).__name__}: {e}", str(run_dir))

        except Exception as e:
            return SimResult(None, {}, SimStatus.UNKNOWN, f"{type(e).__name__}: {e}", str(run_dir))
