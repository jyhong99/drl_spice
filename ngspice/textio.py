...
"""
Text I/O helpers for ngspice artifacts.

Provides safe, explicit read/write helpers for text-based outputs and templates.
"""
...
def read_text(path: PathLike) -> str:
    ...
    if p.is_dir():
        raise TextReadError(p, IsADirectoryError(f"Expected a file path, got directory: {p}"))
