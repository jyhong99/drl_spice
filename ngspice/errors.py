...
"""
Error hierarchy for ngspice execution and parsing.

This module defines structured exception types for:
- parsing failures (RAW-ascii or table schema mismatches)
- execution failures (timeouts, missing outputs, non-zero exits)
- registry and netlist validation issues
"""
